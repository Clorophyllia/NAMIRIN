...
INT f3_silicon_read_event(int32_t BHandle, const char *bank_name, char *pevent, INT off, uint32_t *buff, int size, uint32_t *pdata, int bkm);
...
INT silicon_arya_init(int32_t BHandle2, TRIGGER_SETTINGS *ts);
...
INT silicon_arya_read_event(int32_t BHandle, int32_t BHandle2, const char *bank_name, char *pevent, INT off, uint32_t *buff, int size, uint32_t *pdata, int bkm);
INT silicon_arya_event(uint32_t *ev_buff, int size, EVENT_DATA_SILICON *ev);
BOOL silicon_arya_clear_buffer(int32_t BHandle);

INT silicon_aryb_init(int32_t BHandle2, TRIGGER_SETTINGS *ts);
...
INT silicon_aryb_read_event(int32_t BHandle, int32_t BHandle2, const char *bank_name, char *pevent, INT off, uint32_t *buff, int size, uint32_t *pdata, int bkm);
